...
set( MYSQLCLIENT_NAMES mysqlclient )
find_library( MYSQLCLIENT_LIBRARIES NAMES ${MYSQLCLIENT_NAMES} PATH_SUFFIXES mysql mariadb )
...
find_library( MYSQLCLIENT_STATIC_LIBRARIES NAMES ${MYSQLCLIENT_NAMES} PATH_SUFFIXES mysql mariadb )
...
if( ${MYSQLCLIENT_STATIC_LIBRARIES} MATCHES "NOTFOUND" )
  ...
  message(STATUS "Found static MySQL client library: ${MYSQLCLIENT_STATIC_LIBRARIES}")
endif()

find_path( MYSQLCLIENT_HEADERS mysql.h PATH_SUFFIXES mysql mariadb )

MARK_AS_ADVANCED( MYSQLCLIENT_LIBRARIES MYSQLCLIENT_STATIC_LIBRARIES MYSQLCLIENT_HEADERS )